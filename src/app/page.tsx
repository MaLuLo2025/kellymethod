        ...
        <div className="relative max-w-3xl">
          <FadeIn delay={0.1}>
            <h1 className="font-serif text-display text-ink font-medium mb-8 leading-tight tracking-tight">
              The average POTS patient sees seven doctors and waits almost five years before an accurate diagnosis. Most are told their symptoms are psychiatric. The diagnosis is almost always wrong.
            </h1>
          </FadeIn>
          <FadeIn delay={0.25}>
